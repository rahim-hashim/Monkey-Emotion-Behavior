...
% reward_3f_userloop provides information for the next trial rather than
...
C = [];
timingfile = 'reward_3f_runscene.m';
...
fix_list = {'_fix.png'};
image_list = {'_fractal_A', '_fractal_B', '_fractal_C'};
...
reward_prob_high = 0.9;
reward_prob_med = 0.5;
reward_prob_low = 0.1;

% Set a new condition   
persistent condition_sequence condition_randomized ...
           index_chosen random_num ratio_randomized
